...
var Resource = module.exports = function(config, collections) {
  var type = _s.join('', 'create', _s.capitalize(config.type), 'Client');
 ...
 * @api private
 */
Resource.prototype.createClient = function(config) {
  var client = restify[this.clientType]({
    url: url.format({
