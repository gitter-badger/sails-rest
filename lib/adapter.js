...
module.exports = (function () {
  ...
  var adapter = {
    ...
    defaults: {
      ...
      getPathname: Resource.getPathname,
    ...
    describe: function (connection, collection, cb) {
      return cb(null, grabConnection(connection).definition);
    },
    ...
    define: function (connection, collection, definition, cb) {
      grabConnection(connection).definition = definition;
      return cb();
    },
    ...
    find: function (connection, collection, options, cb) {
      return grabConnection(connection).find(collection, options, cb);
    },

    create: function (connection, collection, values, cb) {
      return grabConnection(connection).create(collection, values, cb);
    },

    update: function (connection, collection, options, values, cb) {
      return grabConnection(connection).update(collection, options, values, cb);
    },

    destroy: function (connection, collection, options, cb) {
      return grabConnection(connection).destroy(collection, options, cb);
    }
